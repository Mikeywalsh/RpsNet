 ...
 * Contains connection info about the client, as well as their name, state, and game ID
 */
public class RemoteClient
{
	/**
	 * Connection info about the client
	 * Used to send and receive packets to and from the client
	 */
    private Connection connection;

	/**
	 * This clients name
	 * This is empty until the client has registered a name
	 */
	private String name;
	 ...
	 * Is empty until the client has registered a name
	...
	/**
	 * Sets the ID of the game that this client has entered
